...
python3 /home/zwq/EECS598_BytePSProj/parameter_server/rpc_parameter_server.py --world_size=3 --rank=1 \
--num_gpus=1 --master_addr=gl1010 --master_port=7214 
