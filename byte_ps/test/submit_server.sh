...
# srun top -b -d 0.5 | grep zwq | grep python3 > /home/zwq/EECS598_BytePSProj/byte_ps/test/logs/byteps_server_0.txt &
srun singularity exec --nv /home/zwq/EECS598_BytePSProj/byte_ps/bytepsimage.simg /home/zwq/EECS598_BytePSProj/byte_ps/distributed_scripts/server.sh
