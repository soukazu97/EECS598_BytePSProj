...
singularity exec --nv /home/$(username)/EECS598_BytePSProj/byte_ps/bytepsimage.simg /home/$(username)/EECS598_BytePSProj/byte_ps/distributed_scripts/scheduler.sh
