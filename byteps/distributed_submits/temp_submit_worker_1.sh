...
timeout 30m top -b -d 0.1 | grep jianbinz | grep python3 > /home/jianbinz/EECS598_BytePSProj/byteps/logs/byteps_worker_1.txt &

singularity exec --nv /home/jianbinz/EECS598_BytePSProj/byteps/bytepsimage.simg /home/jianbinz/EECS598_BytePSProj/byteps/distributed_scripts/temp_run_worker_1.sh
